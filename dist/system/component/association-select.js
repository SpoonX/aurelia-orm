System.register(['aurelia-dependency-injection', 'aurelia-binding', 'aurelia-templating', '../index', 'extend'], function (_export) {
  'use strict';

  var inject, bindingMode, BindingEngine, bindable, customElement, EntityManager, OrmMetadata, Entity, extend, AssociationSelect;
  ...
  return {
    ...
    execute: function () {
      AssociationSelect = (function () {
        ...
        AssociationSelect = inject(BindingEngine, EntityManager, Element)(AssociationSelect) || AssociationSelect;
